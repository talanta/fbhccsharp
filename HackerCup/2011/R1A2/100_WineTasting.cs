...
namespace HackerCup._2011.R1A2
{
    ...
    each contain a test case, which consists of two integers, G and C, separated by a
    single space. G is the total number of glasses of wine and C is the minimum number
    that the person must correctly identify to win.
    ...
    */
    public class WineTasting : IExecutable
    {
